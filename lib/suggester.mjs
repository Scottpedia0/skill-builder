...
const URL_HINTS = {
  "meet.google.com": { id: "meeting-auto-brief", desc: "Auto-generate pre-meeting context brief before calls" },
  "openrouter": { id: "model-cost-monitor", desc: "Track daily model API spend across providers" },
  "github.com": { id: "pr-dashboard", desc: "Morning summary of open PRs, review requests, CI status" },
  "console.anthropic.com": { id: "credential-audit", desc: "Audit API keys — test auth, flag expiring or unused credentials" },
  "console.cloud.google.com": { id: "credential-audit", desc: "Audit API keys — test auth, flag expiring or unused credentials" },
